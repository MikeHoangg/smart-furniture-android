...
public class OptionsEditFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        String optionsData = Preferences.getValue(parent, "EDIT_OPTIONS");
        options = new JsonParser().parse(optionsData).getAsJsonObject();
        ...
        nameField.setText(options.get("name").getAsString());
        heightField.setText(options.get("height").getAsString());
        lengthField.setText(options.get("length").getAsString());
        widthField.setText(options.get("width").getAsString());
        inclineField.setText(options.get("incline").getAsString());
        temperatureField.setText(options.get("temperature").getAsString());
    ...
    private void getSpinners() {
        ...
        typeField.setSelection(types.indexOf(options.get("type").getAsString()));
        ...
        massageField.setSelection(types.indexOf(options.get("massage").getAsString()));
        ...
        rigidityField.setSelection(types.indexOf(options.get("rigidity").getAsString()));
    }
    ...
    private void attemptSave() {
        ...
        if (cancel)
            ...
            showProgress(true);
            parent.api.editOptions(parent.key,
                    options.get("id").getAsInt(),
                    name,
                    type,
