...
public class FurnitureEditFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        String furnitureData = Preferences.getValue(parent, "EDIT_FURNITURE");
        furniture = new JsonParser().parse(furnitureData).getAsJsonObject();
        if (parent.user != null)
            user = parent.user;
        else {
        ...
        codeField.setText(furniture.get("code").getAsString());
        brandField.setText(furniture.get("brand").getAsString());
        typeField.setSelection(types.indexOf(furniture.get("type").getAsString()));
        isPublicField.setChecked(furniture.get("is_public").getAsBoolean());
    ...
    private void attemptSave() {
        ...
        if (cancel)
            ...
            showProgress(true);
            parent.api.editFurniture(parent.key,
                    furniture.get("id").getAsInt(),
                    code,
                    brand,
                    type,
                    is_public,
